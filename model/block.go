...
type BlockModel struct {
	...
	Title        string         `gorm:"column:title;type:varchar(50);not null;comment:'模型名称'"`
	...
	BucketName   string         `gorm:"column:bucket_name;type:varchar(30);comment:'图片minio存储桶名'"`
	Hot          int            `gorm:"column:hot;type:integer;default:0;comment:'热度'"`
	Tags         pq.StringArray `gorm:"column:tags;type:varchar(40)[];comment:'模型标签'"`
